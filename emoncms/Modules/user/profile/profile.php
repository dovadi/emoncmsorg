...
<div class="row">
    ...
    <div class="span4">
        ...
        <div id="account">
        <div class="account-item">
            <span class="muted"><?php echo _('Write API Key'); ?></span> <a style="float:right; cursor:pointer" id="copyapiwritebtn">Copy</a>
            <!--<a id="newapikeywrite" >new</a>-->
            <span class="writeapikey" id="copyapiwrite"></span>
        </div>
        <div class="account-item">
            <span class="muted"><?php echo _('Read API Key'); ?></span> <a style="float:right; cursor:pointer" id="copyapireadbtn">Copy</a>
            <!--<a id="newapikeyread" >new</a>-->
            <span class="readapikey" id="copyapiread"></span>
            <p style="padding-top:15px; color:#aaa" id="msg"></p>
        </div>
        </div>
    </div>
    <div class="span8">
