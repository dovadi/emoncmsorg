...
<table class="table">
    <tr><td><?php echo _('For example using the first json type request above just add the apikey to the end like this:'); ?></td><td><a href="<?php echo $path; ?>input/post?json={power:200}&apikey=<?php echo $user->get_apikey_write($session['userid']); ?>"><?php echo $path; ?>input/post?json={power:200}<b>&apikey=<?php echo $user->get_apikey_write($session['userid']); ?></b></a></td></tr>
</table>

<p><b><?php echo _('Bulk data'); ?></b>
<table class="table">
<tr><td><?php echo _('You can provide data using bulk mode'); ?></td><td><a href="<?php echo $path; ?>input/bulk?data=[[0,16,1137],[2,17,1437,3164],[4,19,1412,3077]]"><?php echo $path; ?>input/bulk?data=[[0,16,1137],[2,17,1437,3164],[4,19,1412,3077]]</a></td></tr>
</table>
<ul>
...
<table class="table">
<tr><td><?php echo _('Legacy default format (4 is now, 2 is -2 seconds and 0 is -4 seconds to now):'); ?></td><td><a href="<?php echo $path; ?>input/bulk?data=[[0,16,1137],[2,17,1437,3164],[4,19,1412,3077]]"><?php echo $path; ?>input/bulk?data=[[0,16,1137],[2,17,1437,3164],[4,19,1412,3077]]</a></td></tr>
<tr><td><?php echo _('Time offset format (-6 is -16 seconds to now):'); ?></td><td><a href="<?php echo $path; ?>input/bulk?data=[[-10,16,1137],[-8,17,1437,3164],[-6,19,1412,3077]]&offset=-10"><?php echo $path; ?>input/bulk?data=[[-10,16,1137],[-8,17,1437,3164],[-6,19,1412,3077]]<b>&offset=-10</b></a></td></tr>
<tr><td><?php echo _('Sentat format: (useful for sending as positive increasing time index)'); ?></td><td><a href="<?php echo $path; ?>input/bulk?data=[[520,16,1137],[530,17,1437,3164],[535,19,1412,3077]]&sentat=543"><?php echo $path; ?>input/bulk?data=[[520,16,1137],[530,17,1437,3164],[535,19,1412,3077]]<b>&sentat=543</b></b></a></td></tr>
<tr><td><?php echo _('Absolute time format (-6 is 1387730121 seconds since 1970-01-01 00:00:00 UTC))'); ?></td><td><a href="<?php echo $path; ?>input/bulk?data=[[-10,16,1137],[-8,17,1437,3164],[-6,19,1412,3077]]&time=<?php echo time(); ?>"><?php echo $path; ?>input/bulk?data=[[-10,16,1137],[-8,17,1437,3164],[-6,19,1412,3077]]<b>&time=<?php echo time(); ?></b></a></td></tr>
</table>
...
<table class="table">
    <tr><td><?php echo _('Add an input process'); ?></td><td><a href="<?php echo $path; ?>input/process/add?inputid=1&processid=1&arg=-1&newfeedname=power"><?php echo $path; ?>input/process/add?inputid=1&processid=1&arg=-1&newfeedname=power</a></td></tr>
    <tr><td><?php echo _('List input process list'); ?></td><td><a href="<?php echo $path; ?>input/process/list?inputid=1"><?php echo $path; ?>input/process/list?inputid=1</a></td></tr>
    <tr><td><?php echo _('Delete input process'); ?></td><td><a href="<?php echo $path; ?>input/process/delete?inputid=1&processid=1"><?php echo $path; ?>input/process/delete?inputid=1&processid=1</a></td></tr>
    <tr><td><?php echo _('Move input process'); ?></td><td><a href="<?php echo $path; ?>input/process/move?inputid=1&processid=1&moveby=1"><?php echo $path; ?>input/process/move?inputid=1&processid=1&moveby=1</a></td></tr>
    <tr><td><?php echo _('Reset input process list'); ?></td><td><a href="<?php echo $path; ?>input/process/reset?inputid=1"><?php echo $path; ?>input/process/reset?inputid=1</a></td></tr>
</table>
